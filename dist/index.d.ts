...
declare function validatePath(target: string, configOverridePath?: string): Promise<{
    diagnostics: Diagnostic[];
    ok: boolean;
    filesScanned: number;
}>;
...
declare function fixPath(target: string, configOverridePath?: string): Promise<{
    validation: {
        diagnostics: Diagnostic[];
        ok: boolean;
        filesScanned: number;
...
export { type AutofixAction, type ComplianceReport, type ComplianceReportFormat, type CrossFileRule, type Diagnostic, type DiagnosticSeverity, type EffectiveRuleSet, type FileRule, type FixResult, type FolderRule, type NormalizedOperationsConfig, type PluginCommand, type PluginRequirement, type RepoSchemaConfig, type ReportCodeSummary, type ReportFinding, type RepotypePresetType, type SchemaBinding, type SectionRule, type TemplateBinding, type TemplateConfig, type ValidateOptions, ValidationEngine, type ValidationResult, type ValidatorAdapter, type ValidatorContext, applyOperationsConfig, createPresetConfig, describePlugins, explainPath, explainRules, findConfig, fixPath, generateComplianceReport, generateFrontmatterSchemaFromContent, generateSchemaFromContent, getOperationsStatus, getRepotypePresetMetadata, initRepotypeConfig, installPluginRequirements, installPlugins, listPresetTypes, loadConfig, parseComplianceReportJson, pluginStatus, renderComplianceReport, renderComplianceReportFromJson, renderHtmlComplianceReport, renderMarkdownComplianceReport, renderTemplate, repotypeApplyCommand, repotypeCleanupRunCommand, repotypeExplainCommand, repotypeFixCommand, repotypeGenerateSchemaCommand, repotypeInitCommand, repotypeInstallChecksCommand, repotypeInstallWatcherCommand, repotypePluginsInstallCommand, repotypePluginsStatusCommand, repotypeReportCommand, repotypeScaffoldCommand, repotypeStatusCommand, repotypeValidateCommand, resolveEffectiveRules, runPluginPhase, scaffoldFromTemplate, startService, validatePath };
